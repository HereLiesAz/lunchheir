...
object LunchHeirHome {
    ...
    fun onCreate(launcher: LawnchairLauncher) {
        ...
        com.hereliesaz.lunchheir.folder.NestedFolders.refresh(launcher)
        ...
        if (LunchHeirPrefs.isEnabled(launcher, LunchHeirPrefs.Feature.GROUPS)) {
            ...
            try {
                val monitor = com.hereliesaz.lunchheir.group.GroupAppMonitor(launcher)
        ...
        try {
            com.hereliesaz.lunchheir.theme.MonochromeShell.apply(launcher)
        } catch (e: Exception) {
